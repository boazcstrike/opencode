...
metadata:
  source: https://github.com/letta-ai/skills/tree/main/tools/google-workspace
---
...
### Search Emails
```bash
uv run python ./scripts/search_emails.py "from:someone@example.com" --credentials ./credentials.json
```
...
### Schedule a Meeting
1. Search calendar for availability: `./scripts/search_events.py --start ... --end ...`
2. Create event: `./scripts/create_event.py --summary "..." --start ... --end ...`

### Reply to Important Emails
1. Find emails needing reply: `./scripts/needs_reply.py`
2. Read specific email: `./scripts/read_email.py <id>`
3. Create draft response: `./scripts/create_draft.py --to ... --subject "Re: ..."`